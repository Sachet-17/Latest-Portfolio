      ...
      try {
        ...
        Object.entries(changesByFile).forEach(([fileName, fileChanges]) => {
          ...
          try {
            ...
            execSync(`git -c user.name="visual-edit" -c user.email="developer@portfolio.dev" add "${targetFile}"`);
            execSync(`git -c user.name="visual-edit" -c user.email="developer@portfolio.dev" commit -m "visual_edit_${timestamp}"`);
          } catch (gitError) {
